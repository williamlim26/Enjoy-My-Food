...
class EaterSignUp extends Component{
  ...
  handleEaterSignUp = (e) => {
    ...
    this.props.handleEaterSignUp(email.value, fname.value, lname.value, password.value, city.value, state.value, zip.value, country.value)
  }
